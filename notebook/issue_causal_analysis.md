...
```
    ...
    /var/folders/qg/19_8zd9x78b4fcgq8j_d8jmc0000gn/T/ipykernel_91586/4034018956.py:19: UserWarning: JVM is already running. tetrad.start() has no effect after the first call — restart the Python process to change the JAR.
      tetrad.start("resources/tetrad-current.jar")
...
```
    ...
    1   mail_dev    silence      TAIL     ARROW  False        False      dd;pl   
    ...
    0      start   b_160705        ta        NaN     0.545455
    1      start   b_160705       nil        NaN     0.272727
    2      start   b_160705        at        NaN     0.181818
    3   mail_dev    silence        ta      dd;pl     0.636364
    4   mail_dev    silence        at      dd;pl     0.363636
...
```
    ...
    causal_graph/causal_graph_full.html
...
```
    ...
    causal_graph/causal_graph_subgraph.html
...
```
    ...
    [['commit', 'mis_link', 'mail_dev', 'thread', 'commit'],
     ['mail_dev', 'thread', 'mis_link', 'mail_dev']]
